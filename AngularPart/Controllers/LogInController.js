'use strict';
app.controller('LogInController', ['$scope', '$location', 'authService', 'chatsHubService', 'webMessengerSettings',
    function ($scope, $location, authService, chatsHubService, webMessengerSettings) {
